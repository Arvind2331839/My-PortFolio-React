...
export default function Home(){
    ...
    return <div className='container-fluid homeBox'>
        ...
        <div className='col-lg-6 text-center'>
            ...
            <h3>Skills:-</h3>
            <p>HTML, CSS, Tailwind css, Bootstrap, Material ui,<br /> Java Script, Type Script, Api's, React js, Redux Toolkit,<br /> Node js, Express js, Mongodb,<br />DSA, Core JAVA, Git & GitHub</p>
            <br/>
            ...
            <br />
            <br />
            <h3>i have one year of experience in mern stack developement from Technorizen software solutions pvt. ltd, Indore, MP</h3><br />
        </div>
        <div className='col-lg-6 text-center'>
