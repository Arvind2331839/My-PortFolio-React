...
import KanbonBoard from './components/KanbonBoardComponent/BlogApp'
import ArogyaSetu from './components/PortfolioComponent/ArogyaSetu'
    ...
    return <>
        ...
        <main>
            ...
            <Routes>
                ...
                <Route path='/blog' element={<KanbonBoard/>}/>
